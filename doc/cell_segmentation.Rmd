...
im <- image_read(path = "../data/C1_cropped_180rot_small.jpg") %>%
  image_crop(geometry = geometry_area(width = 10325, height = 11200, x_off = 2250, y_off = 1015)) %>%
  image_scale("8000") %>%
  as_EBImage()
...
im_cropped <- im[3000:4000, 3000:4000, ]
...
nmask = opening(nmask, makeBrush(3, shape='disc')) #original setting
